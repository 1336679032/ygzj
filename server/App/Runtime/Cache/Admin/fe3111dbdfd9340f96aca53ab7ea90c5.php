...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 订单管理 <span
        class="c-gray en">&gt;</span> 全部订单 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px"
                                              href="javascript:location.replace(location.href);" title="刷新"><i
        class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
    <!--<div>-->
    <!--<div class="aaa_pts_4"><a href="<?php echo U('orderCount');?>?shop_id=<?php echo ($shop_id); ?>" class="btn btn-success">销售统计</a></div>-->
        ...
        <div class="pro_4 bord_1">
            ...
            <div class="pro_5">
                ...
                <select class="inp_1 inp_6" name="pay_status" id="status">
                    ...
                    <?php if ($pay_status==$key) { ?>selected="selected"<?php } ?> ><?php echo $val; ?></option>
                    <?php } ?>
