...
class UserController extends PublicController
{
    ...
    public function getorder()
    {
        ...
        $order['has_num'] = intval(M('order')->where('uid=' . intval($uid) . ' AND status=20 AND del=0')->getField('COUNT(id)'));
    ...
    public function uploadify()
    {
        ...
        $data = array();
        $data['photo'] = "UploadFiles/userImg/" . date("Ymd") . '/' . $filename2;
