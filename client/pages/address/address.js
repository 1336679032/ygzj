...
Page({
  ...
  formSubmit: function (e) {
    ...
    wx.request({
      url: app.d.ceshiUrl + '?s=/Api/Address/addAdds',
      data: {
  ...
  onLoad: function (options) {
    ...
    //获取省级城市
    wx.request({
      url: app.d.ceshiUrl + '?s=/Api/Address/getProvince',
      data: {},
      method: 'POST',
      success: function (res) {
        var status = res.data.status;
  ...
  bindPickerChangeshengArr: function (e) {
    ...
    var that = this;
    wx.request({
      url: app.d.ceshiUrl + '?s=/Api/Address/getCity',
  ...
  bindPickerChangeshiArr: function (e) {
    ...
    var that = this;
    wx.request({
      url: app.d.ceshiUrl + '?s=/Api/Address/getArea',
      data: {
        city: e.detail.value,
        sheng: this.data.sheng
      },
  ...
  bindPickerChangequArr: function (e) {
    ...
    var that = this;
    wx.request({
      url: app.d.ceshiUrl + '?s=/Api/Address/getCode',
      data: {
        quyu: e.detail.value,
        city: this.data.city
      },
