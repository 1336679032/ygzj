...
Page({
    ...
    wx.showModal({
      ...
      success: function (res) {
        res.confirm && wx.request({
          url: app.d.ceshiUrl + '?s=/Api/Order/ordersEdit',
          method: 'post',
          data: {
            id: orderId,
            type: 'cancel',
  ...
  loadOrderList: function () {
    var that = this;
    wx.request({
      url: app.d.ceshiUrl + '?s=/Api/Order/index',
      method: 'post',
      data: {
        uid: app.d.userId,
  ...
  loadReturnOrderList: function () {
    var that = this;
    wx.request({
      url: app.d.ceshiUrl + '?s=/Api/Order/orderRefund',
      method: 'post',
      data: {
        uid: app.d.userId,
  ...
  payOrderByWechat: function (e) {
    ...
    wx.request({
      url: app.d.ceshiUrl + '?s=/Api/Wxpay/wxpay',
      data: {
        order_id: order_id,
        order_sn: order_sn,
        uid: app.d.userId,
